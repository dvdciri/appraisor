...
export default function GenericPanel({ 
  ...
  return (
    <div className={`fixed inset-0 z-[${zIndex}] flex justify-end items-start animate-[fadeIn_0.15s_ease-out]`}>
      {/* Backdrop */}
      <div 
          ...
          <div className="flex items-center gap-3">
            {showBackButton && onBack && (
              <button 
                ...
                title="Go back"
              >
                <svg className="w-5 h-5 text-gray-400 hover:text-gray-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
